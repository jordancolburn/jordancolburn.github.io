...
game running in the browser. The artifacts are saved locally because embedding
directly from Claude.ai sometimes fails:

<iframe src="/assets/claude-artifacts/early-prototype.html" width="100%" height="400" title="Early prototype"></iframe>
...
Here is the final playable artifact, also hosted locally:

<iframe src="/assets/claude-artifacts/final-version.html" width="100%" height="400" title="Final version"></iframe>
